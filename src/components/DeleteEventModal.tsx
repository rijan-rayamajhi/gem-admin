        ...
        <div className="p-6">
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700">
                  <p>This will permanently delete the event and remove all associated data including registrations, insights, and media files.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <div className="text-sm text-gray-600 space-y-1">
              ...
              <p><span className="font-medium">Type:</span> {event.type.replace('_', ' ').toUpperCase()}</p>
              <p><span className="font-medium">Status:</span> {event.status.charAt(0).toUpperCase() + event.status.slice(1)}</p>
              <p><span className="font-medium">Attendees:</span> {event.attendees}/{event.maxAttendees}</p>
