...
import { FAQ } from '../../domain/entities/MonetizationSettings';
import { useState } from 'react';

interface MonetizationFAQsManagerProps {
  faqs?: FAQ[];
  onChange: (faqs: FAQ[]) => void;
}

export default function MonetizationFAQsManager({ faqs, onChange }: MonetizationFAQsManagerProps) {
    ...
    <div className="space-y-4">
      ...
      {safeFAQs.length === 0 ? (
        <div className="text-center py-8 text-muted-foreground border-2 border-dashed border-border rounded-lg">
          <p>No monetization FAQs added yet.</p>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Enter the monetization question..."
                    />
                  </div>
